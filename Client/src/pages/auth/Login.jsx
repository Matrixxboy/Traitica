...
const Login = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] p-4">
      <div className="relative w-full max-w-md p-8 bg-obsessive-black/60 backdrop-blur-md border border-obsessive-dim rounded-lg shadow-[0_0_30px_rgba(0,255,255,0.1)]">
        {/* Decorative corner */}
